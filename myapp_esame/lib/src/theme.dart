...
class Palette {
  ...
  static const red = Color(0xFFF63C30);
...
const paragraphTextStyle = TextStyle(
  fontSize: Grid.medium,
  fontWeight: FontWeight.w500,
  letterSpacing: 0,
  height: null,
);

//Grid.medium è una font size che abbiamo definito in grid.dart
//Grid è una classe che abbiamo definito in grid.dart
//medium è una variabile statica che abbiamo definito in grid.dart
//Grid.medium è uguale a 16.0
...
final lightTheme = AppTheme(
  ...
  bgPrimary60: const Color.fromARGB(172, 248, 248, 248),
  bgPrimary30: const Color.fromARGB(80, 248, 248, 248),
  bgSecondary: const Color(0xFFf1f1f1),
  bgTertiary: const Color(0xFFe6e6e6),
  bgGrey: const Color(0xFFd8d8d8),
  bgGreyLight: const Color.fromARGB(255, 229, 229, 229),
  txtPrimary: const Color(0xFF020202),
  txtPrimary60: const Color.fromARGB(172, 2, 2, 2),
  txtPrimary30: const Color.fromARGB(80, 2, 2, 2),
  txtSecondary: const Color(0xFF181818),
  txtTertiary: const Color(0xFF222222),
  txtGrey: const Color(0xFF444444),
  buttonColor: Palette.red,
  redError: const Color(0xFFff3b30),
  ...
  detailsTextStyle: detailsTextStyle.copyWith(
    color: const Color(0xFF020202),
  ),
);
...
final darkTheme = AppTheme(
  ...
  bgPrimary60: const Color.fromARGB(172, 0, 0, 0),
  bgPrimary30: const Color.fromARGB(80, 0, 0, 0),
  bgSecondary: const Color(0xFF222222),
  bgTertiary: const Color(0xFF333333),
  bgGrey: const Color(0xFF333333),
  bgGreyLight: const Color(0xFF444444),
  txtPrimary: const Color(0xFFF8F8F8),
  txtPrimary60: const Color.fromARGB(172, 248, 248, 248),
  txtPrimary30: const Color.fromARGB(80, 248, 248, 248),
  txtSecondary: const Color(0xFFf1f1f1),
  txtTertiary: const Color(0xFFe6e6e6),
  txtGrey: const Color(0xFFd8d8d8),
  buttonColor: Palette.red,
  redError: const Color(0xFFff3b30),
  titleTextStyle: titleTextStyle.copyWith(
